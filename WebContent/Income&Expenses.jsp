...
<a  class="active" href="Income&Expenses.jsp">Expenses History</a>
...
<form method="get" action="UtilitySearch.jsp">
 ...
 <div class="bod">
 	<div class="searchn">
		<input type="text" class="inputsearch" name="search" class="form-control" placeholder="Enter the title">
...
<div  style="position:absolute; top:478px; left:291px;">  
...
<div class="modelopen">
  <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Generate Report</button>
  ...
  <div id="id01" class="w3-modal w3-animate-opacity">
    <div class="w3-modal-content w3-card-4">
      ...
      <form action="ReportUtpdf" method="get">
