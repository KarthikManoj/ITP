...
<ul>
  ...
  <li><a href="update.jsp">Update Employees</a></li>
    <li><a href="Deletevithu.jsp">Delete Employees</a></li>
  
  
</ul>
<div class="search-container">
<form action="ReportServletVithuEllam" method = "get"> 
 
<button>
REPORT FOR ALL EMPLOYEES
 </button>
</form>
<form action="ReportServletVithu" method = "get"> 
  <input type="text" id="employee" name="username" placeholder="Enter Username.." >
<button>
REPORT
 </button>
 <br>
