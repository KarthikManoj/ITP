...
<input type="text" name="uname" placeholder="Enter Username" id="uname" required ><br/><br/>
...
<button type="submit" value="Login"  id="submit"  required onclick="validate()">Login</button>
