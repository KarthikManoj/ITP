...
<title>GetWellSoon</title>
</head>
<body>

<div class="topnav">
  <a class="active" href="">Home</a>
<a href="Appoint.jsp">Booking</a>
  <a  href="feedback.jsp">Feedback</a>
  <a href="news2.jsp">News</a>
  <a href="contRet.jsp">Contact Us</a>
   <a href="madReport">Report</a>
...
<br>
   ...
   <form action="ReportMaddy" method="get">
  <b>report for total appoints</b><br>
  <button>REPORT</button><br>
  <br><br>
  </form>
  <form action="reportmad" method="get">
  <b>REPORT by date<br></b>
