...
/**
 * Servlet implementation class ReportIncome
 */
...
public class ReportIncome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT a.date,p.nic,p.phone FROM appoint a,payment p where a.AppId=p.payid";         //Fetching data from table
