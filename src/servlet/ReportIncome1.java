...
/**
 * Servlet implementation class ReportIncome1
 */
@WebServlet("/ReportIncome1")
public class ReportIncome1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportIncome1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT a.date,p.nic,p.phone FROM appoint a,payment p where a.AppId=p.payid and date='"+request.getParameter("startdate")+"' ";       //Fetching data from table
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("DATE",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell1=new PdfPCell(new Paragraph("NIC",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell2=new PdfPCell(new Paragraph("PHONE NUMBER",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
