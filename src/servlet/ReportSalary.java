...
/**
 * Servlet implementation class ReportSalary
 */
@WebServlet("/ReportSalary")
public class ReportSalary extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT e.EID,e.firstname,e.profession,e.salary from employee e";         //Fetching data from table
