...
/**
 * Servlet implementation class ReportSalary1
 */
@WebServlet("/ReportSalary1")
public class ReportSalary1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportSalary1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT e.EID,e.firstname,e.profession,e.salary from employee e where EID='"+request.getParameter("eid")+"'";          //Fetching data from table
		    ...
		    PdfPCell cell2=new PdfPCell(new Paragraph("Profession",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell3=new PdfPCell(new Paragraph("Salary",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
