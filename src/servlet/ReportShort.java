...
/**
 * Servlet implementation class ReportShort
 */
@WebServlet("/ReportShort")
public class ReportShort extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from user where sl_no='"+request.getParameter("NIC")+"'";       
