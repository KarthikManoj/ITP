...
/**
 * Servlet implementation class ReportTransport
 */
@WebServlet("/ReportTransport")
public class ReportTransport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("NIC",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell1=new PdfPCell(new Paragraph("Name",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell2=new PdfPCell(new Paragraph("E-mail",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell3=new PdfPCell(new Paragraph("Mobil Number",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
