...
/**
 * Servlet implementation class Report_Patients_User
 */
@WebServlet("/Report_Patients_User")
public class Report_Patients_User extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Report_Patients_User() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from Patient_reg where userID='"+request.getParameter("userID")+"'";       
