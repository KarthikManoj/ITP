...
/**
 * Servlet implementation class Report_Products
 */
@WebServlet("/Report_Products")
public class Report_Products extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from prof where uname='"+request.getParameter("uname")+"' ";       
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("ID",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell2=new PdfPCell(new Paragraph("Product",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell3=new PdfPCell(new Paragraph("Unitprice",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell4=new PdfPCell(new Paragraph("Quantity",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
