...
/**
 * Servlet implementation class Report_Suppliers
 */
@WebServlet("/Report_Suppliers")
public class Report_Suppliers extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Report_Suppliers() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    PdfPCell cell1=new PdfPCell(new Paragraph("User Name",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
