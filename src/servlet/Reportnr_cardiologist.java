...
/**
 * Servlet implementation class Reportnr_cardiologist
 */
@WebServlet("/Reportnr_cardiologist")
public class Reportnr_cardiologist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Reportnr_cardiologist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT * from appoint where type='Cardiologist'";         //Fetching data from table
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("APP ID",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell1=new PdfPCell(new Paragraph("TYPE",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell2=new PdfPCell(new Paragraph("DATE",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell3=new PdfPCell(new Paragraph("TIME",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell4=new PdfPCell(new Paragraph("PATIENT ID",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
