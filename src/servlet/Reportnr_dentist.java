...
/**
 * Servlet implementation class Reportnr_dentist
 */
@WebServlet("/Reportnr_dentist")
public class Reportnr_dentist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Reportnr_dentist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT * from appoint where type='Dentist'";         //Fetching data from table
