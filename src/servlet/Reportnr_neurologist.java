...
/**
 * Servlet implementation class Reportnr_neurologist
 */
@WebServlet("/Reportnr_neurologist")
public class Reportnr_neurologist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Reportnr_neurologist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "SELECT * from appoint where type='Neurologist'";         //Fetching data from table
