...
/**
 * Servlet implementation class reportmad
 */
@WebServlet("/reportmad")
public class reportmad extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from appoint where date='"+request.getParameter("date")+"'";       
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("AppID",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    ...
		    PdfPCell cell4=new PdfPCell(new Paragraph("patientID",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
