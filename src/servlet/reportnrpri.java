...
/**
 * Servlet implementation class reportnrpri
 */
@WebServlet("/reportnrpri")
public class reportnrpri extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from nrecords where patientID='"+request.getParameter("patientID")+"'";       
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("patientID",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell1=new PdfPCell(new Paragraph("Medicine",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
