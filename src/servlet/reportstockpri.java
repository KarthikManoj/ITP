...
/**
 * Servlet implementation class reportstockpri
 */
@WebServlet("/reportstockpri")
public class reportstockpri extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public reportstockpri() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
		    ...
		    String query = "select * from stocks where sname='"+request.getParameter("sname")+"'";       
		    ...
		    PdfPCell cell=new PdfPCell(new Paragraph("SID",FontFactory.getFont("Arial", 12, Font.BOLD,Color.blue)));
		    PdfPCell cell1=new PdfPCell(new Paragraph("Stock Name",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell2=new PdfPCell(new Paragraph("quantity",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell3=new PdfPCell(new Paragraph("Expiry date",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
		    PdfPCell cell4=new PdfPCell(new Paragraph("Received Date",FontFactory.getFont("Arial",12,Font.BOLD,Color.blue)));
